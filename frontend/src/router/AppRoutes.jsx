...
import { PermissionPage } from "../pages/management/permission";
import { RolePage } from "../pages/management/role";
import { UserPage } from "../pages/management/user";
import { WorkflowPage } from "../pages/management/workflow";
...
const AppRoutes = () => {
    return (
        <Routes>
            ...
            <Route path="/manage/role" element={<RolePage />} />
            <Route path="/manage/user" element={<UserPage />} />
            <Route path="/manage/workflow" element={<WorkflowPage />} />
